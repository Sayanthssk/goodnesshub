    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='teacherimages')),
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Admin'), ('INSTITUTE', 'Institute'), ('TEACHER', 'Teacher')], max_length=20)),
